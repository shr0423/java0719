...
public class JoinPage extends Page implements ActionListener{
	...
	public void regist() {
		//아이디,패스워드 등 입려폼의 데이ㅓ를 하나의  DTO에 담아서
		//insert 메서드로 전달하나 call by reference
		Member2 member2=new Member2();
		
		//비어있는  DTO 안에입력폼의 데이터들을 채워넣기 setter잉요
		member2.setId(t_id.getText());//아이디채우기
		member2.setPass(new String(t_pass.getPassword()));
		member2.setName(t_name.getText());//이름채우기
